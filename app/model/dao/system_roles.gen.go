...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.IsDelete = field.NewField(tableName, "is_delete")
	_role.Name = field.NewString(tableName, "name")
	_role.ParentId = field.NewUint(tableName, "parent_id")
	...
	_role.Users = roleManyToManyUsers{
		...
		Role: struct {
			...
			RelationField: field.NewRelation("Users.Role", "model.Role"),
			Users: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Users.Role.Users", "model.User"),
			},
			Menus: struct {
				field.RelationField
				Parameters struct {
				...
				RelationField: field.NewRelation("Users.Role.Menus", "model.Menu"),
				Parameters: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Users.Role.Menus.Parameters", "model.MenuParameter"),
				},
				Roles: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Users.Role.Menus.Roles", "model.Role"),
				},
			},
		},
		Roles: struct {
...
func (r *role) updateTableName(table string) *role {
	...
	r.IsDelete = field.NewField(table, "is_delete")
