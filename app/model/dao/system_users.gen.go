...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.IsDelete = field.NewField(tableName, "is_delete")
	...
	_user.SideMode = field.NewString(tableName, "side_mode")
	_user.BaseColor = field.NewString(tableName, "base_color")
	_user.ActiveColor = field.NewString(tableName, "active_color")
	...
	_user.Role = userBelongsToRole{
		...
		Users: struct {
			...
			Role: struct {
				...
				RelationField: field.NewRelation("Role.Users.Role", "model.Role"),
			},
			Roles: struct {
				field.RelationField
			}{
		...
		Menus: struct {
			...
			Roles: struct {
				...
				RelationField: field.NewRelation("Role.Menus.Roles", "model.Role"),
			},
		},
	}
...
func (u *user) updateTableName(table string) *user {
	...
	u.IsDelete = field.NewField(table, "is_delete")
	...
	u.SideMode = field.NewString(table, "side_mode")
	u.BaseColor = field.NewString(table, "base_color")
	u.ActiveColor = field.NewString(table, "active_color")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["side_mode"] = u.SideMode
	u.fieldMap["base_color"] = u.BaseColor
	u.fieldMap["active_color"] = u.ActiveColor
