...
func newJwtBlacklist(db *gorm.DB, opts ...gen.DOOption) jwtBlacklist {
	...
	_jwtBlacklist.ID = field.NewUint(tableName, "id")
	...
	_jwtBlacklist.IsDelete = field.NewField(tableName, "is_delete")
...
func (j *jwtBlacklist) updateTableName(table string) *jwtBlacklist {
	...
	j.IsDelete = field.NewField(table, "is_delete")
...
func (j *jwtBlacklist) fillFieldMap() {
	...
	j.fieldMap["is_delete"] = j.IsDelete
