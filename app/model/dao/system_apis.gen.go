...
func newApi(db *gorm.DB, opts ...gen.DOOption) api {
	...
	_api.IsDelete = field.NewField(tableName, "is_delete")
	_api.Created = field.NewUint64(tableName, "created")
	_api.Updated = field.NewUint64(tableName, "updated")
	_api.Deleted = field.NewUint64(tableName, "deleted")
	_api.Path = field.NewString(tableName, "path")
	_api.Method = field.NewString(tableName, "method")
	_api.ApiGroup = field.NewString(tableName, "api_group")
	_api.Description = field.NewString(tableName, "description")
	_api.IsEffective = field.NewBool(tableName, "is_effective")
...
func (a *api) updateTableName(table string) *api {
	...
	a.ApiGroup = field.NewString(table, "api_group")
	a.Description = field.NewString(table, "description")
	a.IsEffective = field.NewBool(table, "is_effective")
...
func (a *api) WithContext(ctx context.Context) IApiDo { return a.apiDo.WithContext(ctx) }
...
func (a *api) fillFieldMap() {
	...
	a.fieldMap["api_group"] = a.ApiGroup
	a.fieldMap["description"] = a.Description
	a.fieldMap["is_effective"] = a.IsEffective
}
...
func (a apiDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IApiDo {
