...
func newMenu(db *gorm.DB, opts ...gen.DOOption) menu {
	...
	_menu.IsDelete = field.NewField(tableName, "is_delete")
	...
	_menu.CloseTab = field.NewBool(tableName, "close_tab")
	_menu.KeepAlive = field.NewBool(tableName, "keep_alive")
	_menu.DefaultMenu = field.NewBool(tableName, "default_menu")
	...
	_menu.Roles = menuManyToManyRoles{
		...
		Users: struct {
			...
			Role: struct {
				...
				RelationField: field.NewRelation("Roles.Users.Role", "model.Role"),
			},
			Roles: struct {
				field.RelationField
			}{
		...
		Menus: struct {
			...
			Parameters: struct {
				...
				RelationField: field.NewRelation("Roles.Menus.Parameters", "model.MenuParameter"),
			},
			Roles: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Roles.Menus.Roles", "model.Role"),
			},
		},
	}
...
func (m *menu) updateTableName(table string) *menu {
	...
	m.CloseTab = field.NewBool(table, "close_tab")
	m.KeepAlive = field.NewBool(table, "keep_alive")
	m.DefaultMenu = field.NewBool(table, "default_menu")
...
func (m *menu) fillFieldMap() {
	...
	m.fieldMap["close_tab"] = m.CloseTab
	m.fieldMap["keep_alive"] = m.KeepAlive
	m.fieldMap["default_menu"] = m.DefaultMenu
